...
TData_split <- h2o.splitFrame(data = TData.h2o, ratios = 0.8, seed = 1234)
training_data <- TData_split[[1]]
test_data <- TData_split[[2]]
...
predictors <- c("plantingDate", "harvestDate", "N", "P", "K", "totalRF", "nrRainyDays", "Rain_month1", "Rain_month2", "Rain_month3", "Rain_month4", "AvWindSpeed", "WindSpeed_month1", "WindSpeed_month2", "WindSpeed_month3", "WindSpeed_month4", "Tmax_mean", "Tmax_month1", "Tmax_month2", "Tmax_month3", "Tmax_month4", "Tmin_mean", "Tmin_month1", "Tmin_month2", "Tmin_month3", "Tmin_month4", "altitude", "slope", "TPI", "TRI", "ID", "c_tot_top", "c_tot_bottom", "ca_top", "ca_bottom", "clay_tot_psa_top", 
                "clay_tot_psa_bottom", "db_od_top", "db_od_bottom", "ecec_f_top", "ecec_f_bottom", "fe_top", "fe_bottom", "k_top", "k_bottom", "mg_top", "mg_bottom", "n_tot_ncs_top", "n_tot_ncs_bottom", "oc_top", "oc_bottom", "p_top", "p_bottom", "ph_h2o_top", "ph_h2o_bottom", "s_top", "s_bottom", "sand_tot_psa_top", "sand_tot_psa_bottom", "silt_tot_psa_top", "silt_tot_psa_bottom", "texture_class_top", "texture_class_bottom", "SOM_top", "SOM_bottom", "PWP_top", "PWP_bottom", "FC_top", "FC_bottom", "SWS_top", "SWS_bottom", 
                "B_0_30", "Cu_0_30", "K_0_30", "Mn_0_30", "N_0_30", "P_0_30", "Ptot_0_30")

response <- "Yield"
response


TData_model <- h2o.glm(x = predictors,
                             y = response,
...
test_predict <- h2o.predict(object = TData_model, 
                            newdata = test_data)
...
TData_model_regularized <- h2o.glm(x = predictors,
                                         y = response,
                                         training_frame = training_data,
                                         alpha = 1)
...
h2o.rmse(TData_model, train=TRUE, valid=TRUE)

h2o.r2(TData_model, train=TRUE, valid=TRUE)
...
TData_rf <- h2o.randomForest(x = predictors,
                                   y = response,
                                   ntrees = 25,
                                   max_depth = 5,
                                   training_frame = training_data,
...
#Metric function
h2o.rmse(TData_rf, train=TRUE, valid=TRUE)
h2o.r2(TData_rf, train=TRUE, valid=TRUE)
...
h2o.shap_summary_plot(TData_rf, test_data)
...
train <-h2o.importFile("D:/ICARDA/Transform/ANNR/GeospatialData/train.csv")
test <-h2o.importFile("D:/ICARDA/Transform/ANNR/GeospatialData/test.csv")
...
pred_hf <- as.h2o(pred)
h2o.exportFile(pred_hf, path = "D:/ICARDA/Transform/ANNR/GeospatialData/pred.csv")
